...
def execute_cli():
    ...
    tools = {
        ...
        "remote": (remote_parser, remote_cli.parse_remote_args),
        "add": (remote_parser, remote_cli.parse_add_args),
        "pull": (remote_parser, remote_cli.parse_pull_args),
        "push": (remote_parser, remote_cli.parse_push_args),
        "list": (remote_parser, remote_cli.parse_list_args),
